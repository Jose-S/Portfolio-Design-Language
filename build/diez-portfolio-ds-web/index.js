...
class Palette {
  constructor({
    ...
    text = {h: 0.3333333333333333, s: 1, l: 0.5, a: 1},
    caption = {h: 0.4202898550724637, s: 1, l: 0.6843137254901961, a: 1},
    headerBackground = {stops: [{position: 0, color: {h: 0.7093023255813953, s: 0.6615384615384616, l: 0.12745098039215685, a: 1}}, {position: 1, color: {h: 0.3333333333333333, s: 1, l: 0.5, a: 1}}], start: {x: 0.5, y: 0}, end: {x: 0.5, y: 1}}
  } = {}) {
    /**
    ...
    /**
     * `Colors.black` ( hsla(0.33, 1, 0.5, 1) )
     */
    this.text = new Color(text);
    /**
     * `Colors.purple` ( hsla(0.42, 1, 0.68, 1) )
     */
    this.caption = new Color(caption);
    /**
     * start [0.5, 0], end [0.5, 1], stops: [hsla(0.71, 0.66, 0.13, 1) at 0,hsla(0.33, 1, 0.5, 1) at 1]
     */
...
class Typography {
  constructor({
    heading1 = {font: {file: {src: "assets/SourceSansPro-Regular.ttf", type: "font"}, name: "SourceSansPro-Regular", fallbacks: ["sans-serif"], weight: 400, style: "normal"}, fontSize: 24, color: {h: 0.3333333333333333, s: 1, l: 0.5, a: 1}, lineHeight: -1, letterSpacing: 0, alignment: "natural", decoration: []},
    body = {font: {file: {src: "assets/SourceSansPro-Regular.ttf", type: "font"}, name: "SourceSansPro-Regular", fallbacks: ["sans-serif"], weight: 400, style: "normal"}, fontSize: 18, color: {h: 0.3333333333333333, s: 1, l: 0.5, a: 1}, lineHeight: -1, letterSpacing: 0, alignment: "center", decoration: []},
    caption = {font: {file: {src: "assets/SourceSansPro-Regular.ttf", type: "font"}, name: "SourceSansPro-Regular", fallbacks: ["sans-serif"], weight: 400, style: "normal"}, fontSize: 14, color: {h: 0.4202898550724637, s: 1, l: 0.6843137254901961, a: 1}, lineHeight: -1, letterSpacing: 0, alignment: "natural", decoration: []}
  } = {}) {
    /**
     * - font: `SourceSansPro-Regular, 400, normal`
     * - fontSize: `24`
     * - color: `hsla(0.33, 1, 0.5, 1)`
     * - iosTextStyle: `body`
     * - shouldScale: `false`
     * - lineHeight: `-1`
     * - letterSpacing: `0`
...
class Strings {
  constructor({
    title = "Diez",
    caption = "Keep your designs in sync with code testing this out continue to try this out",
...
class Shadows {
  constructor({
    logo = {offset: {x: 0, y: 1}, radius: 16, color: {h: 0.3333333333333333, s: 1, l: 0.5, a: 0.41000000000000003}}
  } = {}) {
    /**
     * - offset: `[0, 1]`
     * - radius: `16`
     * - color: `hsla(0.33, 1, 0.5, 0.41)`
     */
