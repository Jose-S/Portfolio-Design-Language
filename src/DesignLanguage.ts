...
import { brandArchitectureTokens } from './designs/BrandArchitecture.figma';
/**
...
const colors = {
	...
	black: Color.hex('#00FF00'),
	purple: brandArchitectureTokens.colors.harshOrange,
...
const strings = {
	title: 'Diez',
	caption:
		'Keep your designs in sync with code testing this out continue to try this out',
	helper:
 ...
 *     `diez-portfolio-ds-web`. Look for `App.jsx` inside `examples/web` to see
 ...
 *     called `DiezPortfolioDs`. Look for `ViewController.swift` inside
